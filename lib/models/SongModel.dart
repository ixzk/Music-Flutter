...
@JsonSerializable()
  ...
  List<Song_list> songList;

  SongModel(this.songList,);

  factory SongModel.fromJson(Map<String, dynamic> srcJson) => _$SongModelFromJson(srcJson);
...
@JsonSerializable()
  class Song_list extends Object {
  ...
  Song_list(this.artistId,this.language,this.picBig,this.picSmall,this.country,this.area,this.publishtime,this.albumNo,this.lrclink,this.copyType,this.hot,this.allArtistTingUid,this.resourceType,this.isNew,this.rankChange,this.rank,this.allArtistId,this.style,this.delStatus,this.relateStatus,this.toneid,this.allRate,this.fileDuration,this.hasMvMobile,this.versions,this.bitrateFee,this.biaoshi,this.info,this.hasFilmtv,this.siProxycompany,this.resEncryptionFlag,this.songId,this.title,this.tingUid,this.author,this.albumId,this.albumTitle,this.isFirstPublish,this.havehigh,this.charge,this.hasMv,this.learn,this.songSource,this.piaoId,this.koreanBbSong,this.resourceTypeExt,this.mvProvider,this.artistName,this.picRadio,this.picS500,this.picPremium,this.picHuge,this.album500500,this.album800800,this.album10001000,);

  factory Song_list.fromJson(Map<String, dynamic> srcJson) => _$Song_listFromJson(srcJson);

  Map<String, dynamic> toJson() => _$Song_listToJson(this);
